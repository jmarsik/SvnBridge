...
namespace Tests
{
    ...
    public class MyMocks : MockFramework
    {
        ...
        public delegate void CopyItem(string activityId,
                                      string path,
                                      string targetPath);

        public delegate bool DeleteItem(string activityId,
                                        string path);
        ...
        public delegate ItemMetaData GetItemInActivity(string activityId,
                                                       string path);
        ...
        public delegate int StreamRead(byte[] buffer,
                                       int offset,
                                       int count);

        public delegate bool WriteFile(string activityId,
                                       string path,
                                       byte[] fileData);

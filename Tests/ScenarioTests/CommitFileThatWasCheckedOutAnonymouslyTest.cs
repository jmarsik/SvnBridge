...
{
    [TestFixture]
    public class CommitFileThatWasCheckedOutAnonymouslyTest : WebDavServiceTestsBase
    {
        [Test]
        public void Test1()
        {
        ...
        public void Test2()
        {
            mock.Attach((MyMocks.MakeActivity)provider.MakeActivity, new NetworkAccessDeniedException());
        ...
        public void Test5()
        {
            mock.Attach(provider.GetLatestVersion, 5480);

...
{
    [TestFixture]
    public class CommitDeleteFileTest : WebDavServiceTestsBase
    {
        [Test]
        public void Test1()
        {
        ...
        public void Test11()
        {
            MergeActivityResponse mergeResponse = new MergeActivityResponse(5466, DateTime.Parse("2007-06-12T00:14:48.982631Z"), "jwanagel");

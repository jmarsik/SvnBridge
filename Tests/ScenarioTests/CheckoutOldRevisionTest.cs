...
{
    [TestFixture]
    public class CheckoutOldRevisionTest : WebDavServiceTestsBase
    {
        [Test]
        public void Test1()
        {
            ...
            string expected =
                ...
                "Date: Tue, 12 Jun 2007 22:45:14 GMT\r\n" +
        ...
        public void Test3()
        {
            mock.Attach(provider.GetLatestVersion, 5467);
        ...
        public void Test6()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Tue, 12 Jun 2007 22:45:15 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Vary: Label\r\n" +
                "Content-Length: 440\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bln/5393</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:baseline-collection><D:href>/!svn/bc/5393/</D:href></lp1:baseline-collection>\n" +
                "<lp1:version-name>5393</lp1:version-name>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        public void Test7()
        {
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns1=\"http://subversion.tigris.org/xmlns/dav/\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bc/5393/Spikes/SvnFacade/trunk/New%20Folder%205/</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:version-controlled-configuration><D:href>/!svn/vcc/default</D:href></lp1:version-controlled-configuration>\n" +
                "<lp1:resourcetype><D:collection/></lp1:resourcetype>\n" +
        ...
        public void Test12()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Tue, 12 Jun 2007 22:45:16 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 440\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test14()
        {
            ...
            byte[] fileData = Encoding.UTF8.GetBytes("My text is fun\r\nAnother line added");
            ...
            string request =
                ...
                "Authorization: Basic andhbmFnZWw6UGFzc0B3b3JkMQ==\r\n" +
                "\r\n" +
                "<S:update-report send-all=\"true\" xmlns:S=\"svn:\"><S:src-path>http://localhost:8082/Spikes/SvnFacade/trunk/New%20Folder%205</S:src-path><S:target-revision>5393</S:target-revision><S:entry rev=\"5393\"  start-empty=\"true\"></S:entry></S:update-report>";
            ...
            string expected =
                ...
                "<S:target-revision rev=\"5393\"/>\n" +
                "<S:open-directory rev=\"5393\">\n" +
                "<D:checked-in><D:href>/!svn/ver/5393/Spikes/SvnFacade/trunk/New%20Folder%205</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5393</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-05-16T04:17:42.098980Z</S:set-prop>\n" +
                ...
                "<D:checked-in><D:href>/!svn/ver/5393/Spikes/SvnFacade/trunk/New%20Folder%205/Test1.txt</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5393</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-05-16T04:17:42.098980Z</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:last-author\">jwanagel</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:uuid\">81a5aebe-f34e-eb42-b435-ac1ecbb335f7</S:set-prop>\n" +
                //"<S:txdelta>U1ZOAQAAIgIjAaIiTXkgdGV4dCBpcyBmdW4NCkFub3RoZXIgbGluZSBhZGRlZA==\n" +
                "<S:txdelta>U1ZOAAAAIgEiok15IHRleHQgaXMgZnVuDQpBbm90aGVyIGxpbmUgYWRkZWQ=\n" +
                "</S:txdelta><S:prop><V:md5-checksum>63c4693dc0fcff7a47d20a128634369e</V:md5-checksum></S:prop>\n" +
                "</S:add-file>\n" +
                "<S:prop></S:prop>\n" +
                "</S:open-directory>\n" +
                "</S:update-report>\n" +

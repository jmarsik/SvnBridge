...
{
    [TestFixture]
    public class CheckoutFolderWithEmptyFileTest : WebDavServiceTestsBase
    {
        [Test]
        public void Test1()
        {
            ...
            string expected =
                ...
                "Date: Wed, 13 Jun 2007 01:20:20 GMT\r\n" +
        ...
        public void Test2()
        {
            ...
            string expected =
                ...
                "<lp2:baseline-relative-path>Spikes/SvnFacade/trunk/New Folder 7</lp2:baseline-relative-path>\n" +
        ...
        {
            string request =
                "PROPFIND /!svn/bln/5468 HTTP/1.1\r\n" +
                "Host: localhost:8082\r\n" +
                "User-Agent: SVN/1.4.2 (r22196) neon/0.26.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bln/5468</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:baseline-collection><D:href>/!svn/bc/5468/</D:href></lp1:baseline-collection>\n" +
                "<lp1:version-name>5468</lp1:version-name>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        public void Test5()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 01:20:21 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 732\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test9()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 01:20:22 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 383\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test13()
        {
            ...
            string request =
                "PROPFIND /!svn/bc/5468/Spikes/SvnFacade/trunk/New%20Folder%207 HTTP/1.1\r\n" +
                "Host: localhost:8082\r\n" +
                "User-Agent: SVN/1.4.2 (r22196) neon/0.26.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns1=\"http://subversion.tigris.org/xmlns/dav/\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bc/5468/Spikes/SvnFacade/trunk/New%20Folder%207/</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:version-controlled-configuration><D:href>/!svn/vcc/default</D:href></lp1:version-controlled-configuration>\n" +
                "<lp1:resourcetype><D:collection/></lp1:resourcetype>\n" +
        ...
        public void Test14()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 01:20:23 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 732\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test20()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 01:20:24 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 383\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test23()
        {
            ...
            string request =
                ...
                "Authorization: Basic andhbmFnZWw6UGFzc0B3b3JkMQ==\r\n" +
                "\r\n" +
                "<S:update-report send-all=\"true\" xmlns:S=\"svn:\"><S:src-path>http://localhost:8082/Spikes/SvnFacade/trunk/New%20Folder%207</S:src-path><S:target-revision>5468</S:target-revision><S:entry rev=\"5468\"  start-empty=\"true\"></S:entry></S:update-report>";
            ...
            string expected =
                ...
                "<S:target-revision rev=\"5468\"/>\n" +
                "<S:open-directory rev=\"5468\">\n" +
                "<D:checked-in><D:href>/!svn/ver/5468/Spikes/SvnFacade/trunk/New%20Folder%207</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5468</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-06-13T01:19:42.491788Z</S:set-prop>\n" +
                ...
                "<S:add-file name=\"Empty File.txt\">\n" +
                "<D:checked-in><D:href>/!svn/ver/5468/Spikes/SvnFacade/trunk/New%20Folder%207/Empty%20File.txt</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5468</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-06-13T01:19:42.491788Z</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:last-author\">jwanagel</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:uuid\">81a5aebe-f34e-eb42-b435-ac1ecbb335f7</S:set-prop>\n" +
                //"<S:txdelta>U1ZOAQ==\n" +
                "<S:txdelta>U1ZOAA==\n" +
                "</S:txdelta><S:prop><V:md5-checksum>d41d8cd98f00b204e9800998ecf8427e</V:md5-checksum></S:prop>\n" +
                "</S:add-file>\n" +
                "<S:prop></S:prop>\n" +
                "</S:open-directory>\n" +
                "</S:update-report>\n" +

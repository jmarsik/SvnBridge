...
namespace SvnBridge.Handlers
{
    public class PropFindHandlerTests : HandlerTestsBase
    {
    	...
    	public PropFindHandlerTests()
    	{
            ...
            handler.Initialize(context, new PathParserProjectInPath(tfsUrl, stubs.CreateObject<ProjectInformationRepository>(null, null)));
    	}
        ...
        public void TestInvalidDepthThrowsEx()
        {
			...
			Exception result = Record.Exception(delegate { handler.Handle(context, new PathParserProjectInPath(tfsUrl, stubs.CreateObject<ProjectInformationRepository>(null, null)), null); });

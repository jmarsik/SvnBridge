...
namespace SvnBridge.Handlers
{
    public class PropFindHandlerTests : HandlerTestsBase
    {
    	...
    	public PropFindHandlerTests()
    	{
            ...
            handler.Initialize(context, new PathParserSingleServerWithProjectInPath(tfsUrl, stubs.CreateProjectInformationRepositoryStub()));
    	}
        ...
        public void TestInvalidDepthThrowsEx()
        {
			...
			Exception result = Record.Exception(delegate { handler.Handle(context, new PathParserSingleServerWithProjectInPath(tfsUrl, stubs.CreateProjectInformationRepositoryStub()), null); });

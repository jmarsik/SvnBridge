...
namespace SvnBridge.Handlers
{
    public class ReportHandlerLogReportTests : HandlerTestsBase
    {
        ...
        public void VerifyHandleEncodesFilenamesWithSpecialCharacters()
        {
            ...
            Results r = stubs.Attach(provider.GetLog, new LogItem(@"C:\", "newFolder4", histories.ToArray()));
			...
			handler.Handle(context, new PathParserSingleServerWithProjectInPath("http://tfsserver", stubs.CreateProjectInformationRepositoryStub()), null);
        ...
        public void VerifyHandleForGetAtLogRoot()
        {
            ...
            histories.Add(history1);
            Results r = stubs.Attach(provider.GetLog, new LogItem(@"C:\", "", histories.ToArray()));
        ...
        public void VerifyHandleProducesCorrectOutputForRenamedFile()
        {
            ...
            histories.Add(history1);
            Results r = stubs.Attach(provider.GetLog, new LogItem(@"C:\", "newFolder2", histories.ToArray()));

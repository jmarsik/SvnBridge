...
{
    public class UpdateAfterCommitRenamedFile : ProtocolTestsBase
    {
        [Fact]
        public void Test1()
        {
            ...
            string expected =
                ...
                "Date: Mon, 23 Jul 2007 20:51:16 GMT\r\n" +
        ...
        public void Test2()
        {
            ...
            string expected =
                ...
                "Date: Mon, 23 Jul 2007 20:51:20 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 629\r\n" +
        ...
        public void Test3()
        {
            stubs.Attach(provider.GetLatestVersion, 5525);
            ...
            string expected =
                ...
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:checked-in><D:href>/!svn/bln/5525</D:href></lp1:checked-in>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        {
            string request =
                "PROPFIND /!svn/bln/5525 HTTP/1.1\r\n" +
                "Host: localhost:8082\r\n" +
                "User-Agent: SVN/1.4.2 (r22196) neon/0.26.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bln/5525</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:baseline-collection><D:href>/!svn/bc/5525/</D:href></lp1:baseline-collection>\n" +
                "<lp1:version-name>5525</lp1:version-name>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        public void Test5()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Mon, 23 Jul 2007 20:51:21 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 629\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test9()
        {
            ...
            deletedFile.Name = "FunRenamed.txt";
            ...
            string request =
                ...
                "Authorization: Basic andhbmFnZWw6UGFzc0B3b3JkMQ==\r\n" +
                "\r\n" +
                "<S:update-report send-all=\"true\" xmlns:S=\"svn:\"><S:src-path>http://localhost:8082</S:src-path><S:target-revision>5525</S:target-revision><S:entry rev=\"5524\" ></S:entry></S:update-report>";

            string expected =
                "HTTP/1.1 200 OK\r\n" +
                "Date: Mon, 23 Jul 2007 20:51:22 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                ...
                "<S:target-revision rev=\"5525\"/>\n" +
                "<S:open-directory rev=\"5524\">\n" +
                "<D:checked-in><D:href>/!svn/ver/5525/</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5525</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-07-23T20:50:18.801099Z</S:set-prop>\n" +
                ...
                "<S:delete-entry name=\"FunRenamed.txt\"/>\n" +
                "<S:add-file name=\"Fun3.txt\">\n" +
                "<D:checked-in><D:href>/!svn/ver/5525/Fun3.txt</D:href></D:checked-in>\n" +
                "<S:set-prop name=\"svn:entry:committed-rev\">5525</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:committed-date\">2007-07-23T20:50:18.801099Z</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:last-author\">jwanagel</S:set-prop>\n" +
                "<S:set-prop name=\"svn:entry:uuid\">81a5aebe-f34e-eb42-b435-ac1ecbb335f7</S:set-prop>\n" +
                //"<S:txdelta>U1ZOAQAAAwIEAYMDZnVu\n" +
                "<S:txdelta>U1ZOAAAAAwEDg2Z1bg==\n" +
                "</S:txdelta><S:prop><V:md5-checksum>77004ea213d5fc71acf74a8c9c6795fb</V:md5-checksum></S:prop>\n" +
                "</S:add-file>\n" +
                "<S:prop></S:prop>\n" +
                "</S:open-directory>\n" +
                "</S:update-report>\n" +

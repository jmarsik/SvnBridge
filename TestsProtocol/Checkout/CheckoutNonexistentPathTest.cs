    ...
    public class CheckoutNonExistentPathTest : ProtocolTestsBase
    {
        ...
        public void Test1()
        {
            ...
            string expected =
                ...
                "Date: Wed, 13 Jun 2007 17:04:44 GMT\r\n" +
        ...
        public void Test2()
        {
            ...
            string expected =
                ...
                "Date: Wed, 13 Jun 2007 17:04:48 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 320\r\n" +
                ...
                "</head><body>\n" +
                "<h1>Not Found</h1>\n" +
                "<p>The requested URL /Spikes/SvnFacade/InvalidFolder was not found on this server.</p>\n" +
                "<hr>\n" +
                "<address>Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2 Server at localhost Port 8082</address>\n" +
                "</body></html>\n";
        ...
        public void Test4()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:49 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 383\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
                ...
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:checked-in><D:href>/!svn/bln/5469</D:href></lp1:checked-in>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        {
            string request =
                "PROPFIND /!svn/bln/5469 HTTP/1.1\r\n" +
                "Host: localhost:8082\r\n" +
                "User-Agent: SVN/1.4.2 (r22196) neon/0.26.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bln/5469</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:baseline-collection><D:href>/!svn/bc/5469/</D:href></lp1:baseline-collection>\n" +
                "<lp1:version-name>5469</lp1:version-name>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        public void Test9()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:50 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 440\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test14()
        {
            ...
            string expected =
                "HTTP/1.1 404 Not Found\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:51 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 320\r\n" +
                "Content-Type: text/html; charset=iso-8859-1\r\n" +
                "\r\n" +
        ...
        public void Test17()
        {
            ...
            string expected =
                ...
                "</head><body>\n" +
                "<h1>Not Found</h1>\n" +
                "<p>The requested URL /!svn/bc/5469/Spikes/SvnFacade/InvalidFolder was not found on this server.</p>\n" +
                "<hr>\n" +
                "<address>Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2 Server at localhost Port 8082</address>\n" +
                "</body></html>\n";
        ...
        public void Test18()
        {
            ...
            string expected =
                "HTTP/1.1 401 Authorization Required\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:52 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "WWW-Authenticate: Basic realm=\"CodePlex Subversion Repository\"\r\n" +
                "Content-Length: 493\r\n" +
                "Keep-Alive: timeout=15, max=100\r\n" +
        ...
        public void Test24()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:53 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 690\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test29()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:54 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 383\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test33()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Wed, 13 Jun 2007 17:04:55 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Vary: Label\r\n" +
                "Content-Length: 440\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +

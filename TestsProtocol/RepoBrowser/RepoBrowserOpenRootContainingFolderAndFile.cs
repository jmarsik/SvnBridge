    ...
    public class RepoBrowserOpenRootContainingFolderAndFile : ProtocolTestsBase
    {
        ...
        public void Test1()
        {
            ...
            string expected =
                ...
                "Date: Sun, 21 Sep 2008 19:37:32 GMT\r\n" +
        ...
        public void Test4()
        {
            ...
            string request =
                "PROPFIND /!svn/bln/5767 HTTP/1.1\r\n" +
                "Host: localhost:8080\r\n" +
                "User-Agent: SVN/1.4.6 (r28521) neon/0.27.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
            ...
            string expected =
                ...
                "<D:multistatus xmlns:D=\"DAV:\" xmlns:ns0=\"DAV:\">\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bln/5767</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:baseline-collection><D:href>/!svn/bc/5767/</D:href></lp1:baseline-collection>\n" +
                "<lp1:version-name>5767</lp1:version-name>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
                "</D:propstat>\n" +
                "</D:response>\n" +
        ...
        public void Test5()
        {
            ...
            string expected =
                "HTTP/1.1 401 Authorization Required\r\n" +
                "Date: Sun, 21 Sep 2008 19:37:34 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "WWW-Authenticate: Basic realm=\"CodePlex Subversion Repository\"\r\n" +
                "Content-Length: 493\r\n" +
                "Keep-Alive: timeout=15, max=100\r\n" +
        ...
        public void Test8()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Sun, 21 Sep 2008 19:37:35 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 440\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test12()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Sun, 21 Sep 2008 19:37:36 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 629\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test17()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Sun, 21 Sep 2008 19:37:37 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 1313\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
                ...
                "<lp1:getetag>W/\"5767//\"</lp1:getetag>\n" +
                "<lp1:creationdate>2008-09-21T10:03:51.235865Z</lp1:creationdate>\n" +
                "<lp1:getlastmodified>Sun, 21 Sep 2008 10:03:51 GMT</lp1:getlastmodified>\n" +
                "<lp1:checked-in><D:href>/!svn/ver/5767/</D:href></lp1:checked-in>\n" +
                "<lp1:version-controlled-configuration><D:href>/!svn/vcc/default</D:href></lp1:version-controlled-configuration>\n" +
                "<lp1:version-name>5767</lp1:version-name>\n" +
                "<lp1:creator-displayname>jwanagel</lp1:creator-displayname>\n" +
                "<lp2:baseline-relative-path/>\n" +
                "<lp2:repository-uuid>81a5aebe-f34e-eb42-b435-ac1ecbb335f7</lp2:repository-uuid>\n" +
                "<lp2:deadprop-count>2</lp2:deadprop-count>\n" +
                "<lp1:resourcetype><D:collection/></lp1:resourcetype>\n" +
                "<D:lockdiscovery/>\n" +
                "</D:prop>\n" +
                "<D:status>HTTP/1.1 200 OK</D:status>\n" +
        ...
        {
            string request =
                "REPORT http://localhost:8080 HTTP/1.1\r\n" +
                "Host: localhost:8080\r\n" +
                "User-Agent: SVN/1.4.6 (r28521) neon/0.27.2\r\n" +
                "Connection: TE\r\n" +
                "TE: trailers\r\n" +
        ...
        public void Test21()
        {
            ...
            string expected =
                "HTTP/1.1 207 Multi-Status\r\n" +
                "Date: Sun, 21 Sep 2008 19:37:38 GMT\r\n" +
                "Server: Apache/2.0.59 (Win32) SVN/1.4.2 DAV/2\r\n" +
                "Content-Length: 410\r\n" +
                "Content-Type: text/xml; charset=\"utf-8\"\r\n" +
                "\r\n" +
        ...
        public void Test22()
        {
            ...
            item.Author = "jwanagel";
            item.LastModifiedDate = DateTime.Parse("2008-01-20T08:55:13.330897Z");
            result.Items.Add(item);
            item = new ItemMetaData();
            item.Name = "H !@#$%^&()_-+={[}];',.~`.txt";
            item.ItemRevision = 5738;
            item.Author = "jwanagel";
            item.LastModifiedDate = DateTime.Parse("2008-03-17T20:21:44.979631Z");
            result.Items.Add(item);
            stubs.Attach(provider.GetItems, result);
            stubs.AttachReadFile(provider.ReadFile, GetBytes("test3"));
            ...
            string expected =
                ...
                "</D:response>\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\" xmlns:g0=\"DAV:\">\n" +
                "<D:href>/!svn/bc/5767/A%20!@%23$%25%5e&amp;()_-+=%7b%5b%7d%5d%3b',.~%60/</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:creator-displayname>jwanagel</lp1:creator-displayname>\n" +
                "<lp1:creationdate>2008-01-20T08:55:13.330897Z</lp1:creationdate>\n" +
                ...
                "</D:response>\n" +
                "<D:response xmlns:lp1=\"DAV:\" xmlns:lp2=\"http://subversion.tigris.org/xmlns/dav/\">\n" +
                "<D:href>/!svn/bc/5767/H%20!@%23$%25%5e&amp;()_-+=%7b%5b%7d%5d%3b',.~%60.txt</D:href>\n" +
                "<D:propstat>\n" +
                "<D:prop>\n" +
                "<lp1:creator-displayname>jwanagel</lp1:creator-displayname>\n" +
                "<lp1:creationdate>2008-03-17T20:21:44.979631Z</lp1:creationdate>\n" +
                "<lp1:version-name>5738</lp1:version-name>\n" +
                "<lp2:deadprop-count>0</lp2:deadprop-count>\n" +

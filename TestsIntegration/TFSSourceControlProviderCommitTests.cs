...
namespace Tests
{
    public class TFSSourceControlProviderCommitTests : TFSSourceControlProviderTestsBase
    {
        ...
        public void TestCommitReplacedFile()
        {
            ...
            // Assert TFS history
            LogItem log1 = _provider.GetLog(testPath + "/TestFile.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
        ...
        public void TestCommitNewSubFolderInNewFolder()
        {
            ...
            Assert.AreEqual(ItemType.Folder, _provider.GetItems(-1, testPath + "/TestFolder/SubFolder", Recursion.None).ItemType);
            Assert.AreEqual(_provider.GetLatestVersion(), response.Version);
        ...
        public void TestCommitRenameFile()
        {
            ...
            LogItem log = _provider.GetLog(testPath + "/FunRename.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
        ...
        public void TestCommitBranchFile()
        {
            ...
            LogItem log = _provider.GetLog(testPath + "/FunBranch.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
        ...
        public void TestCommitMoveFileOutOfFolderAndDeleteFolder()
        {
            ...
            LogItem log = _provider.GetLog(testPath + "/FunFile.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
            Assert.AreEqual(ChangeType.Rename, log.History[0].Changes[0].ChangeType);
        ...
        public void TestCommitMoveAnUpdateFile()
        {
            ...
            LogItem log = _provider.GetLog(testPath + "/Protocol/Fun.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
            Assert.AreEqual(ChangeType.Rename | ChangeType.Edit, log.History[0].Changes[0].ChangeType);
        ...
        public void TestCommitMoveFolderWithUpdatedFile()
        {
            ...
            LogItem log = _provider.GetLog(testPath + "/B/A/Test.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
            Assert.AreEqual(ChangeType.Rename | ChangeType.Edit, log.History[0].Changes[0].ChangeType);
        ...
        public void TestCommitMoveMultipleFilesFromDeletedFolderIntoNewFolder()
        {
            ...
            LogItem log1 = _provider.GetLog(testPath + "/B/Test1.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
            Assert.AreEqual(ChangeType.Rename, log1.History[0].Changes[0].ChangeType);
            LogItem log2 = _provider.GetLog(testPath + "/B/Test2.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
        ...
        public void TestCommitRenameFolderContainingUpdatedFile()
        {
            ...
            LogItem log1 = _provider.GetLog(testPath + "/B", 1, _provider.GetLatestVersion(), Recursion.None, 1);
            Assert.AreEqual(ChangeType.Rename, log1.History[0].Changes[0].ChangeType);
            LogItem log2 = _provider.GetLog(testPath + "/B/Test.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);
        ...
        public void TestCommitMoveAnUpdatedFileThenDeleteFolderThatContainedFile()
        {
            ...
            LogItem log2 = _provider.GetLog(testPath + "/B/Test1.txt", 1, _provider.GetLatestVersion(), Recursion.None, 1);

namespace SvnBridge.Views
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.GetServerUrlFromRequest = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// okButton
			// 
			this.okButton.Location = new System.Drawing.Point(158, 90);
			...
			// txtPortNumber
			// 
			this.txtPortNumber.Location = new System.Drawing.Point(145, 59);
			...
			// txtTfsUrl
			// 
			this.txtTfsUrl.Location = new System.Drawing.Point(145, 30);
			...
			this.cancelButton.Location = new System.Drawing.Point(241, 90);
			...
			// proxyButton
			// 
			this.proxyButton.Location = new System.Drawing.Point(15, 90);
			...
			// 
			this.GetServerUrlFromRequest.AutoSize = true;
			this.GetServerUrlFromRequest.Location = new System.Drawing.Point(13, 9);
			this.GetServerUrlFromRequest.Name = "GetServerUrlFromRequest";
			this.GetServerUrlFromRequest.Size = new System.Drawing.Size(171, 17);
			this.GetServerUrlFromRequest.TabIndex = 8;
			this.GetServerUrlFromRequest.Text = "Dynamically discover server url";
			this.GetServerUrlFromRequest.UseVisualStyleBackColor = true;
			this.GetServerUrlFromRequest.CheckedChanged += new System.EventHandler(this.GetServerUrlFromRequest_CheckedChanged);
			// 
			// SettingsForm
			// 
			...
			this.Controls.Add(this.GetServerUrlFromRequest);
		...
		private System.Windows.Forms.CheckBox GetServerUrlFromRequest;
    }
}
